...
/*
	...
	The USB ports on the STM32F3Discovery board shall face towards the positive Y axis of the vehicle,
...
#define L3GD20_CS_GPIO 			GPIOE, GPIO3
...
#define L3GD20_GYRO_SEQUENTIAL_READ_MASK		(1<<6)
